...
assert(domain.includes("REMOVE_COURSE_ROLE: ['operations', 'admin']") && domain.includes("'COURSE_ROLE_REMOVED'") && domain.includes('COURSE_MANAGER_REPLACEMENT_REQUIRED'), 'Course role removal must be server-authorized, audited and protect active reviewer assignments.');
