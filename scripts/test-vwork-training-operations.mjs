...
assert(page.includes("!['overview', 'structure', 'team'].includes(tab) && <div className=\"training-context-bar\"") && page.includes('layer-course-entry'), 'The overview, structure, and course-role screens must use their focused layouts instead of duplicating the global context selectors.');
