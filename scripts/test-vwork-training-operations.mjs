...
assert(domain.includes("REMOVE_COURSE_ROLE: ['operations', 'admin']") && domain.includes("'COURSE_ROLE_REMOVED'") && domain.includes("task.status = 'NEEDS_REASSIGNMENT'") && domain.includes('affectedTaskIds') && !domain.includes('COURSE_MEMBER_REASSIGNMENT_REQUIRED'), 'Course role removal must be immediate, retain assignment history, and clear active task identities for reassignment.');
