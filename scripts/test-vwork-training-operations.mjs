...
assert(page.includes('Nguồn input hiện có (giữ dữ liệu cũ)') && page.includes('InputVersionSnapshot') && page.includes('TaskDetailedInputs') && page.includes("if (tab === 'inputs') return true;"), 'Scoped managers and members consume detailed inputs both in the task layer and input workspace.');
