...
assert(!api.includes('canReceiveVWorkTasks') && api.includes('assignable: active') && api.includes('accounts.filter((item) => item.assignable)'), 'Every active VWork account, regardless of role, must be eligible to receive tasks.');
