...
assert(page.includes('Gán vai trò theo khóa học') && page.includes('Gỡ khỏi khóa') && page.includes('Thêm khóa học') && page.includes('CopyPlus') && page.includes('Nhân bản khóa'), 'Course administration must expose removable course memberships and retain add/duplicate actions using the shared icon library.');
