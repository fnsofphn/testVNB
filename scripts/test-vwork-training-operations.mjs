...
assert(page.includes("role === 'intake' ? 'Input lớp học'") && page.includes("if (role === 'intake') return <div className=\"input-workspace-stack\"><SaleRosterInputs") && page.includes('Việc của tôi · cập nhật danh sách lớp'), 'Sale Input must open the roster upload workspace instead of an empty class-task page.');
