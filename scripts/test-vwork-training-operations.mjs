...
assert(domain.includes("REMOVE_COURSE_ROLE: ['operations', 'admin']") && domain.includes("'COURSE_ROLE_REMOVED'") && domain.includes('retainedTaskIds') && !domain.includes('COURSE_MEMBER_REASSIGNMENT_REQUIRED'), 'Course role removal must be server-authorized, audited, immediate, and preserve historical task identities.');
