...
export const TRAINING_TASK_TEMPLATES = Object.freeze([
  ...
  { group: 'setup', code: 'T-104', title: 'Khởi tạo hoạt động thảo luận', inputKey: 'discussion', system: 'VTRAINING', detailInputKey: 'vtrainingDiscussion', requiredInputCodes: ['D03', 'D06'], dueOffset: 2, dependsOnTemplates: ['T-102'], checklist: ['Tên và mô tả các chủ đề thảo luận', 'Danh sách học viên theo lớp đã chia nhóm', 'Thời lượng mỗi phiên'] },
  { group: 'setup', code: 'T-105', title: 'Khởi tạo bài kiểm tra', inputKey: 'test', system: 'VTRAINING', detailInputKey: 'vtrainingTest', requiredInputCodes: ['D08'], dueOffset: 2, dependsOnTemplates: ['T-102'], checklist: ['Bộ câu hỏi kiểm tra', 'Số câu hỏi mỗi bài, thời gian hoàn thành, số lượt làm'] },
  { group: 'setup', code: 'T-106', title: 'Khởi tạo bài thu hoạch', inputKey: 'assignment', system: 'VTRAINING', detailInputKey: 'vtrainingAssignment', requiredInputCodes: ['D07'], dueOffset: 2, dependsOnTemplates: ['T-102'], checklist: ['Các câu hỏi thu hoạch', 'Thời gian và số lượt làm bài'] },
  { group: 'setup', code: 'T-107', title: 'Khởi tạo game', inputKey: 'game', system: 'VTRAINING', detailInputKey: 'vtrainingGame', requiredInputCodes: ['D05'], dueOffset: 2, dependsOnTemplates: ['T-102'], checklist: ['Tên game đầy đủ và tên trên hệ thống', 'Số lượt và thời gian chơi'] },
  { group: 'setup', code: 'T-109', title: 'Khởi tạo tài liệu', inputKey: 'material', system: 'VTRAINING', detailInputKey: 'vtrainingMaterial', requiredInputCodes: ['D09'], dueOffset: 2, dependsOnTemplates: ['T-102'], checklist: ['Agenda', 'Tài liệu học tập'] },
  ...
  { group: 'setup', code: 'T-108', title: 'Khởi tạo bài giảng', inputKey: 'vlearning', system: 'VLEARNING', detailInputKey: 'vlearningLesson', requiredInputCodes: ['D04'], dueOffset: 2, dependsOnTemplates: ['T-112'], checklist: ['File Excel từng bài giảng, tên bài và tên các phần', 'Link Vimeo, câu hỏi cuối bài nếu có'] },
